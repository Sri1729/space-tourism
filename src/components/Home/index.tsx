...
export const HomeComp = () => {
  return (
    <div className="flex flex-1 flex-col h-auto justify-between items-center md:justify-around lg:flex-row lg:items-end lg:h-fit lg:self-center lg:relative lg:top-12">
      ...
      <button className="flex w-40 h-40 rounded-full text-xl font-normal bg-white items-center justify-center uppercase tracking-widest font-heading md:h-56 md:w-56 md:text-3xl lg:h-64 lg:w-64 hover:drop-shadow-exploreBtn">
        Explore
      </button>
    </div>
  );
